...
latex_documents = [
  ('index', 'aiokafka.tex', 'aiokafka Documentation', '', 'manual'),
]
...
man_pages = [
    ('index', 'aiokafka', 'aiokafka Documentation', [], 1)
]
...
texinfo_documents = [
  ('index', 'aiokafka', 'aiokafka Documentation',
   '', 'aiokafka', 'One line description of project.',
   'Miscellaneous'),
]
